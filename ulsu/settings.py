...
STATICFILES_DIRS = (
    ...
    # Put strings here, like "/home/html/staticfiles" or "C:/www/django/staticfiles".
    # Always use forward slashes, even on Windows.
    # Don't forget to use absolute paths, not relative paths.
)

# List of finder classes that know how to find staticfiles files in
# various locations.
STATICFILES_FINDERS = (
...
ROOT_URLCONF = 'ulsu.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'ulsu.wsgi.application'
...
TEMPLATE_DIRS = (
                ...
                ) + tuple([os.path.join(PROJECT_PATH, i['type'], 'templates') for i in CUSTOM_APPS])
...
INSTALLED_APPS = (
                     ...
                     'core',
                     'ckeditor',
                 ) + tuple([i['type'] for i in CUSTOM_APPS])
